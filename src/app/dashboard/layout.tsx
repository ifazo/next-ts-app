...
import { Bars2Icon, ChatBubbleLeftRightIcon, CalendarIcon, ChartBarIcon, FolderIcon, HomeIcon, InboxIcon, UserIcon, UsersIcon, XMarkIcon } from '@heroicons/react/24/outline'
